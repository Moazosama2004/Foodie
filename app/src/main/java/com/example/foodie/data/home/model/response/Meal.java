...
public class Meal implements Parcelable {
    ...
    // Note: Room ignores methods, so getIngredients() requires no changes
    // and no TypeConverter because it computes data from the existing String fields.
    ...
    // Helper accessors for list generation
